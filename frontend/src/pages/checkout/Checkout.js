            ...
            <div className="limit-check">
                ...
                <div className="info-check">
                    ...
                    <div className="payment-check">
                        ...
                        <input onChange = {(e)=> {setcarddetails(false) ; setPayment('At delivery')}} type="radio" name="home" id="home"/><label for="home" className="this-label"> At delivery</label>
                        ...
                        <Input variant="flushed" id="name-card" placeholder="ghassen roudesly"/></div>
