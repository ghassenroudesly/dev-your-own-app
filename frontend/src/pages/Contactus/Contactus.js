...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:ghassenroudesly11@gmail.com?subject=Sample&body=${body}`)
    }
    return (
        ...
        <div className="headerContact">
            <Image className="imageContact" src='https://i.imgur.com/RuH87nk.png' alt="contactImage" objectFit="cover"/>
            ...
            <div className="showAdrss">
                ...
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">TnStore@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
